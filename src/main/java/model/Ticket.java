...
public class Ticket {
    ...
    public String toStringDetails() {
		...
		return AllConstants.TICKET_ID + id + "\n" +  AllConstants.CREATED_AT + created_at + "\n" +  AllConstants.REQUESTED_ID + requester_id + "\n" +  AllConstants.ASSIGNEE_ID
				+ assignee_id + "\n" +  AllConstants.SUBJECT + subject + "\n" +  AllConstants.TAGS + Arrays.toString(tags) + "\n" +  AllConstants.DESCRIPTION
				+ description + "\n";
    }
}
